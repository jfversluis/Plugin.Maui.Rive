...
public class RiveEventReceivedEventArgs : EventArgs
{
    ...
    /// <summary>The delay in seconds at which the event was fired.</summary>
    public float Delay { get; }

    /// <summary>Custom properties attached to the event.</summary>
...
{
    /// <summary>The animation or state machine name, if available.</summary>
